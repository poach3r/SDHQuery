...
public class GetReviewByName extends AbstractCommand {
    private final Config cfg;
    private final Gson gson;
    private String url;

    public GetReviewByName(Config cfg) {
        super(Commands.slash("getreview", "Gets the review for a game if one is available.")
